...
public class BookControllercx {
    ...
    public String doLogin(String user_code, String password, HttpSession session){
        Users users = userServicecx.selectUser(user_code);
        if(users==null){
    ...
    public String selectBook(Model model, String book_name, Integer book_type, Integer is_borrow, HttpServletRequest request){
        ...
        int pageSize=4;
        List<Book_info> book_infos = bookServicecx.selectBook(book_type, is_borrow, book_name, Num, pageSize);
